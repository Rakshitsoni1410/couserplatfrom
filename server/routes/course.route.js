...
import { createCourse,editCourse,getCourseById, getCreatorCourses,createCourseLecture, getCourseLecture, editLecture, removeLecture, getLectureById, togglePublishCourse, getPublishedCourse, searchCourse } from '../controllers/course.controller.js';
...
router.get("/published-courses", getPublishedCourses);//publish course
