...
const Profile = () => {
  ...
  const [updateUser, { isLoading: updateUserLoading, isError, error, isSuccess }] = useUpdateUserMutation();
  ...
  const updateUserHandler = async () => {
    ...
    formData.append("name", name || data?.user?.name || ""); // Ensure name is always populated
